...
from datasets.cbis_ddsmconfig import TRAIN_CSV, VAL_CSV, IMG_DIR, BATCH_SIZE, LEARNING_RATE, NUM_EPOCHS, DEVICE
from datasets.cbis_ddsmBreastDensityJSONDataset import BreastDensityJSONDataset
...
def save_results(train_loss_history, val_loss_history, train_time, trial_dir=None):
    results_dir = "/home/christian/CrossDomainBreastCancer/results"
